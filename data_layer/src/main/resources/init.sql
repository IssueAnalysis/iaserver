...
INSERT INTO `db_test1`.`user_info`(`id`, `user_id`, `user_name`, `user_password`, `real_name`, `mobile`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (2, '1002', 'lisi', '333222', '李四', '15678298934', '我是DB2 - 李四', now(), now(), 0);
INSERT INTO `db_test1`.`user_info`(`id`, `user_id`, `user_name`, `user_password`, `real_name`, `mobile`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (3, '1003', 'wangwu', '555666', '王五', '18778298934', '我是DB2 - 王五', now(), now(), 0);
